...
export const APIS = [AdminControllerService, ArticlesService, ArticlesImportService, AuthentificationService, CategoriesService, ClientsService, CommandeClientsService, CommandeFournisseursService, ConditionsDeVentesService, EntreprisesService, FournisseursService, LivraisonsService, ManagementService, ModesPayementService, MouvementsDeStockService, ReportsService, SousCategoriesService, UnitsService, UtilisateursService, UtilisateursEntreprisesService, VentesService];
