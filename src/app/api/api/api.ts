...
export const APIS = [AdminControllerService, ArticlesService, AuthentificationService, CategoriesService, ClientsService, CommandeClientsService, CommandeFournisseursService, ConditionsDeVentesService, EntreprisesService, FournisseursService, ManagementService, ModesPayementService, MouvementsDeStockService, ReportsService, SousCategoriesService, UnitsService, UtilisateursService, VentesService];
